...
$weatherProvinsi = json_decode(file_get_contents("https://api.bmkg.go.id/publik/prakiraan-cuaca?adm1=" . $kode_provinsi), true);
...
// Data utama lokasi
if (isset($weatherProvinsi['lokasi'])) {
    $lokasiArray = $weatherProvinsi['lokasi'];
}

// Proses data cuaca dan lokasi tambahan
if (isset($weatherProvinsi['data']) && is_array($weatherProvinsi['data'])) {
    foreach ($weatherProvinsi['data'] as $index => $data) {
               ...
               ?>
                  <div class="mb-4 p-4 bg-gray-800 rounded-lg shadow-lg">
                     <div class="flex items-center mb-4">
                        ...
                        <span class="ml-auto text-lg">Provinsi <b><?php echo htmlspecialchars($lokasiData['provinsi']); ?></b></span>
                     </div>
