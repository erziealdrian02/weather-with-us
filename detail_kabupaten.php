...
$weatherKabupaten = json_decode(file_get_contents("https://api.bmkg.go.id/publik/prakiraan-cuaca?adm2=" . $kode_kabupaten), true);
...
// Data utama lokasi
if (isset($weatherKabupaten['lokasi'])) {
    $lokasiArray = $weatherKabupaten['lokasi'];
}

// Proses data cuaca dan lokasi tambahan
if (isset($weatherKabupaten['data']) && is_array($weatherKabupaten['data'])) {
    foreach ($weatherKabupaten['data'] as $index => $data) {
               ...
               ?>
                  <div class="mb-4 p-4 bg-gray-800 rounded-lg shadow-lg">
                     <div class="flex items-center mb-4">
                        <a href="detail_kecamatan.php?kecamatan=<?php echo htmlspecialchars($lokasiData['adm3']); ?>" class="group inline-flex items-center hover:text-blue-500 transition-colors">  
                           <span class="font-bold text-xl mr-2">  
                              <?php echo htmlspecialchars($lokasiData['kecamatan'] ?? 'Tidak Diketahui'); ?>  
                           </span>  
                        ...
                        <span class="ml-auto text-lg">Kab. /Kota <b><?php echo htmlspecialchars($lokasiData['kotkab']); ?></b> - Kec. <b><?php echo htmlspecialchars($lokasiData['kecamatan']); ?></b></span>
                     </div>
